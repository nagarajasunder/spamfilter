...
import com.geekydroid.spamfilter.databinding.MessageItemBinding

class Adapter(private val list: ArrayList<Message>) : RecyclerView.Adapter<Adapter.ViewHolder>() {
    /**
    ...
    fun loadMoreItems(moreItems:ArrayList<Message>) {
